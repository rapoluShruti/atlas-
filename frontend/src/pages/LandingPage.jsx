      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-16">
        <div className="text-center lg:text-left">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="text-orange-600 block">Mindful Yoga Practice</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Link
              className="bg-orange-500 text-white px-8 py-4 rounded-xl hover:bg-orange-600 transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-center"
              to="/register"
            >
              🚀 Start Your Journey
            </Link>
            <Link
              className="bg-white text-orange-600 px-8 py-4 rounded-xl border-2 border-orange-200 hover:border-orange-300 transition-all duration-200 font-semibold text-lg shadow-md hover:shadow-lg text-center"
              to="/login"
            >
              Sign In
            </Link>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-orange-100">
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center space-x-1 bg-orange-100 px-4 py-2 rounded-full">
                <span className="text-orange-600 font-semibold">🧘 10,000+</span>
